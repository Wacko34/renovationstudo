          ...
          >
            ...
            <div class="mb-3 border border-lightgray rounded">
              <div class="flex flex-wrap">
                <div class="w-1/2 text-center">
                  <div
                    id="div-switch"
                    :class="email ? 'm-0.5 bg-main rounded pt-1 pb-1' : 'm-0.5 bg-white rounded pt-1 pb-1 hover:bg-grey'"
                  >
                    <a
                      type="button"
                      @click="changeInputLoginType()"
                    >Почта</a>
                  </div>
                </div>
                <div class="w-1/2 text-center">
            ...
            <div class="mb-1.5">
              <div class="relative flex items-stretch w-full">
                ...
                >
                  <span class="input-group-text cumancen  text-sm h-full"><i :class="passIsHidden ? 'fas fa-eye' : 'fas fa-eye-slash'" /></span>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-wrap mb-2 text-center">
              <button
                type="submit"
                class="w-4/5 mx-auto h-9 color-btn inline-block align-middle text-center select-none border border-none font-normal whitespace-no-wrap rounded leading-normal no-underline bg-purchase hover:bg-gray"
              >
                Войти
              </button>
            </div>
            ...
            <div class="flex flex-wrap mb-3 text-center">
              <button
                type="submit"
                class="w-4/5 mx-auto h-9 color-btn inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded leading-normal no-underline bg-white hover:bg-purchase hover:text-white border-main text-main"
              >
                Зарегестрироваться
              </button>
            </div>
